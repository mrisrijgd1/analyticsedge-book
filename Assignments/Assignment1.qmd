...
```{r}
mvt <- read.csv("/cloud/project/analyticsedge/Datasets/mvtWeek1.csv")
```
...
```{r}
IBM <- read.csv("/cloud/project/analyticsedge/Datasets/IBMStock.csv")
GE <- read.csv("/cloud/project/analyticsedge/Datasets/GEStock.csv")
ProcterGamble <- read.csv("/cloud/project/analyticsedge/Datasets/ProcterGambleStock.csv")
CocaCola <- read.csv("/cloud/project/analyticsedge/Datasets/CocaColaStock.csv")
Boeing <- read.csv("/cloud/project/analyticsedge/Datasets/BoeingStock.csv")
```
...
```{r}
CPS <- read.csv("/cloud/project/analyticsedge/Datasets/CPSData.csv")
```
...
```{r}
MetroAreaMap <- read.csv("/cloud/project/analyticsedge/Datasets/MetroAreaCodes.csv")
CountryMap <- read.csv("/cloud/project/analyticsedge/Datasets/CountryCodes.csv")
```
...
```{r}
poll <- read.csv("/cloud/project/analyticsedge/Datasets/AnonymityPoll.csv")
```
