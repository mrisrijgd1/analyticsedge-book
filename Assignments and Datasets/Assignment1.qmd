...
```{r}
mvt <- read.csv("Datasets/mvtWeek1.csv")
```
...
```{r}
CPS <- read.csv("Datasets/CPSData.csv")
```
...
```{r}
MetroAreaMap <- read.csv("Datasets/MetroAreaCodes.csv")
CountryMap <- read.csv("Datasets/CountryCodes.csv")
```
